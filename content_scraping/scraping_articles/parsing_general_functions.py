...
def main_parse_content(paper_name, html_content_dict, parsed_file, dropped_file, parsed_attr, searchterms, redo=False, keep_ids=True):
    """
    ...
    if redo:
        ...
        #if ids should be unchanged even when re-parsing, store them in a list
        if keep_ids:

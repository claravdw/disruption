    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.thesun.co.uk%26t%3dnewsworldnews';
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=5583&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph;
                if(sf2!=null){imgUrl+='&sf2='+sf2;}
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=5583&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + ecid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=9a23326a-79e5-4504-8b6d-88d10e340b51',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=305',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=00d816dd-9693-4964-bab4-3a1356f695b6',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=305&id=5583',
                                SiteSectionId: 5583,
                                SiteId: 961,

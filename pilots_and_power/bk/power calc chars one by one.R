#code to be substituted into the simulation function in
#power calculation characteristics.R, in order to test
#bivariate regressions instead of the block-by-block strategy
